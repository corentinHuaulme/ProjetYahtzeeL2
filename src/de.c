...
void lancerDe(de_t * de[], int nbLancer){
	...
	for(i=0;i<nbLancer;i++){
		...
		switch(de[i]->nombreFace){
			case 1 :
				de[i]->nomImage="../ressources/deUn.png";
				break;
			case 2 :
				de[i]->nomImage="../ressources/DeDeux.png";
				break;
			case 3 :
				de[i]->nomImage="../ressources/DeTrois.png";
				break;
			case 4 :
				de[i]->nomImage="../ressources/DeQuatre.png";
				break;
			case 5 :
				de[i]->nomImage="../ressources/DeCinq.png";
				break;
			case 6 :
				de[i]->nomImage="../ressources/DeSix.png";
				break;
		}
	}
}
