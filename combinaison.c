...
combinaison_t * creerCombinaison(de_t ** tab){
	...
	for(i=0;i<5;i++){
		...
		switch (tab[i]->nombreFace){
			case 1 :
				combi->cpt1=combi->cpt1+1;
				break;
			case 2 :
				combi->cpt2=combi->cpt2+1;
				break;
			case 3 :
				combi->cpt3=combi->cpt3+1;
				break;
			case 4 :
				combi->cpt4=combi->cpt4+1;
				break;
			case 5 :
				combi->cpt5=combi->cpt5+1;
				break;
			case 6 :
				combi->cpt6=combi->cpt6+1;
				break;
		}
	}
	return combi;
